    ...
    <div className="footer">
      <div className="sections">
        ...
        <div className="links-w">
          ...
          <br />
          {links.map((item, i) => {
            return <Item label={item.label} url={item.url} />;
          })}
        </div>
      ...
      <div className="links-f">
        <Link className="social-link" to={`${youtube}`} target="_blank">
          <FontAwesomeIcon alt="Our Youtube" icon={faYoutube}></FontAwesomeIcon>
        </Link>
        ...
        <Link className="social-link" to={`${twitter}`} target="_blank">
          <FontAwesomeIcon alt="Our Twitter" icon={faTwitter}></FontAwesomeIcon>
        </Link>
      </div>
    </div>
  );
